...
println("Starting execution of: pink_oyster_v2.lua")
...
fan_cycle_period                 = 283        -- unit: seconds
---------------------------------------------

-----------------Variables-------------------
sunrise                          = 8          -- in hours (8:00 AM) TBD: get it from the config.json
deadline_epoch                   = get_start_epoch() + 86400  -- Example: 1 day after start
fan_phases                       = {7, 7, 7, 7, 150, 7, 7, 7, 7, 77}  -- duration of each phase in seconds, 10 sec is the minimum
